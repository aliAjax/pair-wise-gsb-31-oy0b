...
- 首页瀑布流浏览、分类筛选、关键词搜索，交换中的物品继续露出并带“交换中”角标。
- 物品详情、物主资料、选择自己的物品发起交换。
- 发布物品，支持本地 base64 图片上传、分类和成色选择。
- 交换管理，区分我发起的和我收到的请求，支持同意、拒绝、撤回、双方确认完成。
- 同一件物品可被多人同时请求；物主同意一笔后，两件物品一起进入“交换中”，其余等待中的请求自动变为“交换已另行达成”，不能继续抢这两件物品。
- 已同意的交换任一方都能撤回，撤回后两件物品恢复“可交换”，先前被另行达成的请求不跟着复活。
- 双方确认完成后，两件物品一起变成“已交换”。
- 个人中心，编辑资料、上传头像、查看我发布的物品和交换中计数。
